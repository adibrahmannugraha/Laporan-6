...
public class Manager extends Employee {
    ...
    public Manager(int id, int masuk, String nama, String jabatan, String status, int anak) {
    ...
    public double Gaji() {
        ...
        return GAJI + BONUS + TUNJANGAN + TUNJANGANKELUARGA + (0.1 * (GAJI + (GAJI * TAHUN * 0.05) + TUNJANGAN));
    }
}
